...
namespace Game::Handlers
{
    ...
    inline void PointsRule(SCallbackData& callback, CMainServer* main_server)
    {
        ...
        const auto old_score = static_cast<int32_t>(room_cache->score_rule);
        ...
        LogRoomSettingChange(acc_index, acc_index, server_id, room_cache->room_id,
            RoomLog::EventType::ScoreRuleChanged, old_score, static_cast<int32_t>(max_points));
        acc_cache.unlock();
