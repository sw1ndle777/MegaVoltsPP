...
namespace Game::Handlers
{
    ...
    inline void HostAttackShotgun(SCallbackData& callback, CCastServer* server)
    {
        ...
        for (uint8_t i = 0; i < cnt; i++)
        {
            ...
            DEBUGLOG(green, "WEAPON_HIT weapon=SHOTGUN attackerSid=({}) victimSid=({}) hp=({}) bodypart=({}) playerStatus=({}) idk2=({})",
